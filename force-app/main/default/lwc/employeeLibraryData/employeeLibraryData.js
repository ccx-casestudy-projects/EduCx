...
import allBorrowedBooksOfEmployee from '@salesforce/apex/BookIssueAndReturnController.allBorrowedBooksUser';
import returnBook from '@salesforce/apex/BookIssueAndReturnController.returnBook';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
export default class EmployeeLibraryData extends LightningElement {
    @api employeeName ;
    @api employeeId;
    @api employeeLogin;
    @track allbooks;
  ...
  { label: "Book Id", fieldName: "BookId", hideDefaultActions: true },
    ...
    @api candidateType;
    @api show;
    @wire(allBorrowedBooksOfEmployee, { recordId: '$employeeId',candidateType:'$candidateType' })
   wiredbooks(result) {
